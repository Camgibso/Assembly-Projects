...
;get user input
	prompt BYTE  "Assign a number for N: ",0
	prompt3 BYTE "Assign a number for R: ",0
...
;what prints
	...
	answer2Combo BYTE "The combination is %1d", 10,0
	answer2Permu BYTE "The permutation is %1d", 10,0
...
;moves N to rdx then pushes onto stack for calculation
	mov rdx, userInput
	push rdx

;gets value from rax and prints it
	call Fact 
	mov rdx, rax
	lea rcx, answer
	call printf
...
;prints menu and gets input, stores it in rdx for comparison
	lea rcx,disp2			   
	call printf
    lea rdx, num              
    lea rcx, inFmt            
